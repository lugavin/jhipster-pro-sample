...
import CommonTableFieldComponent from '@/entities/modelConfig/common-table-field/common-table-field.vue';
import CommonTableFieldClass from '@/entities/modelConfig/common-table-field/common-table-field.component';
