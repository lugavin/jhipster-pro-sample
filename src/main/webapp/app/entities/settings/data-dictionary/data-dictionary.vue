<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-data-dictionary-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="dataDictionaryId" :parentId="parentId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./data-dictionary.component.ts"></script>
<style>
