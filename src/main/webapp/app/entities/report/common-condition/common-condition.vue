<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-common-condition-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="commonConditionId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./common-condition.component.ts"></script>
<style>
