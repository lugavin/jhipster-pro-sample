<template>
  <a-card :bordered="false">
    ...
    <a-drawer
      ...
      :maskClosable="false"
    >
      <iframe :src="reportUrl" width="100%" height="100%" seamless title="报表设计"></iframe>
    </a-drawer>
    <a-modal
      title="新增或编辑"
      ...
      :maskClosable="false"
    >
      <jhi-u-report-file-update
        :commonTableId="commonTableId"
        @cancel="updateModalCancel"
        :showInModal="true"
        :uReportFileId="clickUReportFileId"
      />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./u-report-file.component.ts"></script>
<style>
