<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-statistics-api-update @cancel="updateModalCancel" :showInModal="true" :updateEntityId="statisticsApiId" />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./statistics-api.component.ts"></script>
<style>
