<template>
  <a-card :bordered="false">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <jhi-common-condition-item-update
        :commonConditionId="commonConditionId"
        @cancel="updateModalCancel"
        :showInModal="true"
        :updateEntityId="commonConditionItemId"
      />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./common-condition-item.component.ts"></script>
<style>
