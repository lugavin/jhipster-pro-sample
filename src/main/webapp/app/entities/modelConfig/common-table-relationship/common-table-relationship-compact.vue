<template>
  <a-card :bordered="false" :bodyStyle="{ padding: 0 }">
    ...
    <a-modal
      ...
      :maskClosable="false"
    >
      <common-table-relationship-update
        :commonTableId="commonTableId"
        @cancel="updateModalCancel"
        :showInModal="true"
        :commonTableRelationshipId="commonTableRelationshipId"
      />
    </a-modal>
  </a-card>
</template>

<script lang="ts" src="./common-table-relationship-compact.component.ts"></script>
<style>
