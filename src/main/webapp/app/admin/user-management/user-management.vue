        ...
        <thead>
          <tr>
            ...
            <th v-on:click="changeOrder('login')">
              <span v-text="$t('userManagement.login')">Login</span> <font-awesome-icon icon="sort"></font-awesome-icon>
            </th>
            <th v-on:click="changeOrder('email')">
              <span v-text="$t('userManagement.email')">Email</span> <font-awesome-icon icon="sort"></font-awesome-icon>
            </th>
            <th></th>
            <th v-on:click="changeOrder('langKey')">
              <span v-text="$t('userManagement.langKey')">Lang Key</span> <font-awesome-icon icon="sort"></font-awesome-icon>
            </th>
            <th><span v-text="$t('userManagement.profiles')">Profiles</span></th>
            <th v-on:click="changeOrder('createdDate')">
              <span v-text="$t('userManagement.createdDate')">Created Date</span> <font-awesome-icon icon="sort"></font-awesome-icon>
            </th>
            <th v-on:click="changeOrder('lastModifiedBy')">
              <span v-text="$t('userManagement.lastModifiedBy')">Last Modified By</span> <font-awesome-icon icon="sort"></font-awesome-icon>
            </th>
