...
export const asyncRouterMap = [
  {
    ...
    meta: { title: '首页', authorities: ['ROLE_ADMIN'] },
    ...
    children: [
      {
        path: 'login',
        name: 'login',
        component: () => import(/* webpackChunkName: "user" */ '@/views/user/MyLogin'),
      },
      {
        path: 'register',
        name: 'register',
...

  {
    ...
    children: [
      // dashboard
      {
        ...
        redirect: '/dashboard/analysis',
        component: RouteView,
        meta: { title: '仪表盘', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'], authorities: ['ROLE_ADMIN'] },
        children: [
          {
            path: '/dashboard/analysis',
            name: 'Analysis',
          ...
          },
          {
            ...
            name: 'Workplace',
            component: () => import('@/views/dashboard/Workplace'),
            meta: { title: '工作台', keepAlive: true, permission: ['dashboard'], authorities: ['ROLE_ADMIN'] },
          },
          {
            path: '/dashboard/test-work',
            name: 'TestWork',
