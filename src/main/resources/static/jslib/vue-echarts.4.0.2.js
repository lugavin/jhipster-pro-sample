...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = t(require('echarts/lib/echarts')))
    : 'function' == typeof define && define.amd
    ? define(['echarts/lib/echarts'], t)
    : ((e = e || self).VueECharts = t(e.echarts));
})(this, function (e) {
  'use strict';
  ...
  var $ = function (e, i, n) {
      ...
      return (
        (i = S(i) || 0),
        t(n) && ((h = !!n.leading), (a = (_ = 'maxWait' in n) ? j(S(n.maxWait) || 0, i) : a), (f = 'trailing' in n ? !!n.trailing : f)),
        (b.cancel = function () {
  ...
  function U(e, t, i) {
    return (window.getComputedStyle(e, i || null) || { display: 'none' })[t];
  }
  function W(e) {
    if (!document.documentElement.contains(e)) return { detached: !0, rendered: !1 };
    for (var t = e; t !== document; ) {
      if ('none' === U(t, 'display')) return { detached: !1, rendered: !1 };
      t = t.parentNode;
    }
      ...
      (e.__resize_mutation_handler__ ||
        (e.__resize_mutation_handler__ = function () {
          ...
          t !== this.__resize_rendered__ &&
            (!i && this.__resize_triggers__ && (q(this), this.addEventListener('scroll', k, !0)), (this.__resize_rendered__ = t), B(this));
        }.bind(e)),
      ...
      if (((e.__resize_listeners__ = []), window.ResizeObserver)) {
        var i = e.offsetWidth,
          ...
          r = new ResizeObserver(function () {
            (e.__resize_observer_triggered__ || ((e.__resize_observer_triggered__ = !0), e.offsetWidth !== i || e.offsetHeight !== n)) &&
              B(e);
          }),
          o = W(e),
          s = o.detached,
        ...
        (function (e) {
          ...
          var i = N('div', { className: 'resize-triggers' }),
            n = N('div', { className: 'resize-expand-trigger' }),
            r = N('div'),
            o = N('div', { className: 'resize-contract-trigger' });
          n.appendChild(r),
            i.appendChild(n),
            i.appendChild(o),
            e.appendChild(i),
            (e.__resize_triggers__ = { triggers: i, expand: n, expandChild: r, contract: o }),
            q(e),
            e.addEventListener('scroll', k, !0),
            (e.__resize_last__ = { width: e.offsetWidth, height: e.offsetHeight });
        })(e),
        (e.__resize_rendered__ = W(e).rendered),
        window.MutationObserver)
      ) {
        var c = new MutationObserver(e.__resize_mutation_handler__);
        c.observe(document, { attributes: !0, childList: !0, characterData: !0, subtree: !0 }), (e.__resize_mutation_observer__ = c);
      }
      ...
      (this.__resize_raf__ =
        ((t = function () {
          var e,
            ...
            s,
            a =
              ((t = (e = i).__resize_last__),
              (n = t.width),
              (r = t.height),
              (o = e.offsetWidth),
              (s = e.offsetHeight),
              o !== n || s !== r ? { width: o, height: s } : null);
    ...
    X = {
      ...
      methods: {
        mergeOptions: function (e, t, i) {
          this.manualUpdate && (this.manualOptions = e), this.chart ? this.delegateMethod('setOption', e, t, i) : this.init();
        },
        ...
        init: function () {
          ...
          if (!this.chart) {
            ...
            this.group && (i.group = this.group),
              i.setOption(this.manualOptions || this.options || {}, !0),
              ...
              this.autoresize &&
                ...
                (this.__resizeHandler = $(
                  function () {
                    0 === t.lastArea
                      ? (t.mergeOptions({}, !0), t.resize(), t.mergeOptions(t.options || t.manualOptions || {}, !0))
                      : t.resize(),
                      (t.lastArea = t.getArea());
                  },
                  100,
                  { leading: !0 }
                )),
                P(this.$el, this.__resizeHandler)),
        ...
        initOptionsWatcher: function () {
          var e = this;
          this.__unwatchOptions && (this.__unwatchOptions(), (this.__unwatchOptions = null)),
            this.manualUpdate ||
          ...
          this.autoresize &&
            (function (e, t) {
              ...
              i &&
                ...
                i.length ||
                  (e.__resize_observer__
                    ...
                    : (e.__resize_mutation_observer__ &&
                        (e.__resize_mutation_observer__.disconnect(), (e.__resize_mutation_observer__ = null)),
                ...
                !--F && H && H.parentNode.removeChild(H));
            })(this.$el, this.__resizeHandler),
            this.dispose(),
            (this.chart = null);
        },
        refresh: function () {
  ...
  return (function (e, t, i, n, r, o, s, a, c, d) {
    ...
    if (
      (e && e.render && ((u.render = e.render), (u.staticRenderFns = e.staticRenderFns), (u._compiled = !0), r && (u.functional = !0)),
      n && (u._scopeId = n),
      o
        ? ((l = function (e) {
    ...
    function (e) {
      e && e('data-v-4975117c_0', { source: '.echarts{width:600px;height:400px}', map: void 0, media: void 0 });
    },
    Y,
    void 0,
    !1,
        ...
        return (function (e, t) {
          ...
          if (!n.ids.has(e)) {
            ...
            if (
              ...
              n.styles.push(r), (n.element.styleSheet.cssText = n.styles.filter(Boolean).join('\n'));
            else {
              var o = n.ids.size - 1,
                s = document.createTextNode(r),
                a = n.element.childNodes;
              a[o] && n.element.removeChild(a[o]), a.length ? n.element.insertBefore(s, a[o]) : n.element.appendChild(s);
            }
          }
        })(e, t);
      };
